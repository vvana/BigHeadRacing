...
## спуск по ~52 м (пологие — на подъёме уклон ≤ 14%), между ними короткий
...
## круге («перепад высот сделан слишком неравномерно»). Переходы шире самой прямой и захватывают края соседних дуг —
